...
public class ListPolynomial extends AbstractPolynomial {
    ...
    public void insertAtEnd(double coefficient) {
        insertAtPosition(coefficients.size(), coefficient);
    }
    ...
    public ListPolynomial plus(ListPolynomial another) {
        ...
        if (maxLength == this.coefficients.size()) {
            for (int i = minLength; i < maxLength; i++) {
                listPlus.add(i,this.coefficientAt(i));
            }
        } else {
            for (int i = minLength; i < maxLength; i++) {
                listPlus.set(i, another.coefficientAt(i));
            }
        }
    ...
    public ListPolynomial minus(ListPolynomial another) {
        ...
        if (maxLength == this.coefficients.size()) {
            for (int i = minLength; i < maxLength; i++) {
                listMinus.add(i, this.coefficientAt(i));
            }
        } else {
            for (int i = minLength; i < maxLength; i++) {
                listMinus.add(i, -another.coefficientAt(i));
            }
        }
