...
//        testRootSolver();
    ...
    public static void testIntegrator() {
        System.out.println("Test Integrator");
        /*
         TODO
        ...
        IntegrationCaculator integrationCaculator = new IntegrationCaculator(ap1);
        integrationCaculator.setIntegrator(new MidpointRule(0.01, 100));
